 ...
 * @author minht
 */
public class FormListAlmostOver extends javax.swing.JFrame {

    /**
     * Creates new form FormListAlmostOver
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Danh sách sản phẩm sắp hêt");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormListAlmostOver.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormListAlmostOver().setVisible(true);
            }
        });
    }
